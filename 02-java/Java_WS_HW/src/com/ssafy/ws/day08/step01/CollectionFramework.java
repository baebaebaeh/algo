package com.ssafy.ws.day08.step01;
...
//		____<____, ____> scoreMap = new ____<____, ____>();
//		
//		// Q. 수학은 100점, 국어는 90점, 영어는 80점을 저장해 봅시다.
//		scoreMap.____("수학", 100);
//		scoreMap.____("국어", 90);
//		scoreMap.____("영어", 80);
//		
//		// Q. scoreMap에 저장된 '키'를 출력해 봅시다.
//		System.out.println("scoreMap keys: " + scoreMap.____());
//		
//		// Q. scoreMap에 저장된 데이터를 출력해 봅시다.
//		for(String subject : scoreMap.____()) {
//			System.out.println(subject + ": " + scoreMap.____(subject));
//		}
//		
